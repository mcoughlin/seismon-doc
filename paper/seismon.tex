...
\hspace*{-0.5cm}
 ...
 \caption{The predicted peak ground acceleration as a function of magnitude and distance for LHO (left) and LLO (right). The differences are likely related to site effects.}
 \label{fig:MvsR}
\end{figure*}
